    ...
    let arrayList = tasks.map((list, key) => {
        ...
        return (
            <li key={ key } data-key={ key } >
                <svg onClick={ this.props.handleDelete } className="list-check" fill={ list.category } version="1.1" xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 512 512">
